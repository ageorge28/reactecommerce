                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                Invoice: <strong><span class="text-danger">{{ $order->invoice_no }}</span></strong>
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <span class="badge badge-pill" style="background-color: #FF0000; color: white">
                                                    {{ $order->order_status }}
                                                </span>
                                            </li>
                                            <li class="list-group-item">
                                                ...
                                                <span class="badge badge-pill" style="background-color: darkblue; color: white">
                                                    {{ $order->payment_status ? 'PAID' : 'UNPAID' }}
                                                </span>
                                            </li>
                                            <br />
                                            @if($order->order_status == 'Pending')
                                                <a href="{{ route('admin.orders.process', $order->id) }}" class="btn btn-block btn-success">Process Order</a>
                                            @elseif($order->order_status == 'Processing')
                                                <a href="{{ route('admin.orders.complete', $order->id) }}" class="btn btn-block btn-success">Complete Order</a>
                                            @endif
                                        </ul>
