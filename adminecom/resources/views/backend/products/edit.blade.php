                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <img id="showImage" style="width:100px; height:100px"
                                                src="{{ $product->image != null ? asset('upload/products/thumbnails/' . $product->image) : asset('upload/no_image.jpg') }}" />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="short_description" name="short_description" rows="3">{{ $productDetail->short_description }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="long_description" name="long_description" rows="3">{{ $productDetail->long_description }}</textarea>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="price"
                                                    name="price" placeholder="00.00" value="{{ $product->price }}">
                                                    @error('price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="special_price"
                                                    name="special_price" placeholder="00.00" value="{{ $product->special_price }}">
                                                    @error('special_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" id="subcategory" name="subcategory">
                                                    ...
                                                    @foreach ($subcategories as $subcategory)
                                                        <option value="{{ $subcategory->subcategory_name }}" {{ $subcategory->subcategory_name == $product->subcategory ? ' selected' : ''}}>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="remark" id="Featured"
                                                        value="FEATURED" {{ $product->remark == 'FEATURED' ? ' checked' : '' }}>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="remark" id="New"
                                                        value="NEW" {{ $product->remark == 'NEW' ? ' checked' : '' }}>
                                                    <label class="form-check-label" for="New">NEW</label>
                                                </div>

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="remark"
                                                        id="Collection" value="COLLECTION" {{ $product->remark == 'COLLECTION' ? ' checked' : '' }}>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="color" name="color"
                                                    data-role="tagsinput" placeholder="Enter Product Colors" value="{{ $productDetail->color }}">
                                            </div>
