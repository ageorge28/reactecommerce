...
class ProductDetails extends Component {
  ...
  addToFavourite = () => {
    ...
    {
      axios.get(AppURL.AddFavourite(productCode, email))
      .then(response =>{
        if(response.data===1){
          cogoToast.success("Product Added to Favourites Successfully",{position:'top-right'});
          this.setState({
            addToFavourite:"Favourite",
            PageRefreshStatus: true
          });
          ...
          cogoToast.error("Your Request is not done ! Try Aagain",{position:'top-right'});
          this.setState({addToFavourite:"Add To Cart"})
        }
  ...
  render() {
    ...
    let image_one = ProductAllData['productDetails'][0]['image1'];
    let image_two = ProductAllData['productDetails'][0]['image2'];
    let image_three = ProductAllData['productDetails'][0]['image3'];
    let image_four = ProductAllData['productDetails'][0]['image4'];
        ...
        <Container fluid={true}  className="BetweenTwoSection">
          <div className="breadbody">
            <Breadcrumb>
              ...
              <Breadcrumb.Item> <Link to={"/subcategory/"+category+"/"+subcategory}> {subcategory } </Link> </Breadcrumb.Item>
